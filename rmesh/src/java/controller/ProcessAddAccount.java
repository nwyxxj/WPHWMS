 ...
 */
@WebServlet(name = "ProcessAddAccount", urlPatterns = {"/ProcessAddAccount"})
public class ProcessAddAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userType.equals("admin")) {
            if (InputValidation.validateUser(userType, userID) == false) {
                ...
                session.setAttribute("successMessageCreateAccount","New account has been created successfully!");          
