...
<html>
    ...
    <center>
        ...
        <table style ="border-spacing:80px 10px"><tr>
                ...
                <td height = "200" width ="150" bgcolor = WhiteSmoke> <b><a href="HARDCODEviewWardAInformation.jsp">Ward A</a></b><br></td>
                    <%} else if (ward.equals("Ward B")) {%>
                <td height = "200" width ="150" bgcolor = WhiteSmoke> <b><a href="HARDCODEviewWardBInformation.jsp">Ward B</a></b><br></td>
                    <%} else {%>
                <td height = "200" width ="150" bgcolor = WhiteSmoke> <b><a href="HARDCODEviewWardCInformation.jsp">Ward C</a></b><br></td>
                    <%}%>
